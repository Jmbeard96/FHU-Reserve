...
public class RoomSet{
    ...
    static var roomsForTimes = [[
        ...
        Room(roomNumber: 233, imageName: "studyRoom", amenities: ["White board"], availableTimes: [8, 9, 13, 15, 17, 22], capacity: 2),
        Room(roomNumber: 107, imageName: "studyRoom", amenities: ["TV"], availableTimes: [8, 9, 10, 13, 15, 16, 17, 20], capacity: 3)
    ],
    [
        Room(roomNumber: 233, imageName: "studyRoom", amenities: ["White board"], availableTimes: [8, 9, 13, 15, 17, 22], capacity: 2),
        Room(roomNumber: 107, imageName: "studyRoom", amenities: ["TV"], availableTimes: [8, 9, 10, 13, 15, 16, 17, 20], capacity: 3)
